...
class TPoolStats(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'num_running', None, None, ), # 1
    (2, TType.I64, 'num_queued', None, None, ), # 2
    (3, TType.I64, 'mem_usage', None, None, ), # 3
    (4, TType.I64, 'mem_estimate', None, None, ), # 4
  )

  def __init__(self, num_running=None, num_queued=None, mem_usage=None, mem_estimate=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.mem_usage = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.I64:
          self.mem_estimate = iprot.readI64();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.num_running is not None:
      oprot.writeFieldBegin('num_running', TType.I64, 1)
    ...
    if self.mem_usage is not None:
      oprot.writeFieldBegin('mem_usage', TType.I64, 3)
      oprot.writeI64(self.mem_usage)
      oprot.writeFieldEnd()
    if self.mem_estimate is not None:
      oprot.writeFieldBegin('mem_estimate', TType.I64, 4)
      oprot.writeI64(self.mem_estimate)
      oprot.writeFieldEnd()
  ...
  def validate(self):
    if self.num_running is None:
      raise TProtocol.TProtocolException(message='Required field num_running is unset!')
    ...
    if self.mem_usage is None:
      raise TProtocol.TProtocolException(message='Required field mem_usage is unset!')
    if self.mem_estimate is None:
      raise TProtocol.TProtocolException(message='Required field mem_estimate is unset!')
    return
...
class TBackendDescriptor(object):
  ...
  thrift_spec = (
    ...
    (4, TType.BOOL, 'secure_webserver', None, None, ), # 4
  )

  def __init__(self, address=None, ip_address=None, debug_http_address=None, secure_webserver=None,):
  ...
  def write(self, oprot):
    ...
    if self.secure_webserver is not None:
      oprot.writeFieldBegin('secure_webserver', TType.BOOL, 4)
