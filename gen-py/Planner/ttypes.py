...
class TPlanFragment(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'display_name', None, None, ), # 1
  ...
  def __init__(self, display_name=None, plan=None, output_exprs=None, output_sink=None, partition=None,):
...
class TScanRangeLocation(object):
  ...
  def __init__(self, server=None, volume_id=thrift_spec[2][4], is_cached=thrift_spec[3][4],):
    self.server = server
...
class TScanRangeLocations(object):
  """
  Attributes:
   - scan_range
   - locations
