...
class TLlamaServiceVersion(object):
  V1 = 0
...
class TLocationEnforcement(object):
  MUST = 0
  PREFERRED = 1
  DONT_CARE = 2
...
class TAllocatedResource(object):
  """
  Attributes:
   - reservation_id
   - client_resource_id
...
class TLlamaAMRegisterRequest(object):
  """
  Attributes:
   - version
   - client_id
...
class TLlamaAMRegisterResponse(object):
  """
  Attributes:
   - status
   - am_handle
...
class TLlamaAMUnregisterRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMUnregisterResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaAMReservationRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMReservationResponse(object):
  """
  Attributes:
   - status
   - reservation_id
...
class TLlamaAMReservationExpansionRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMReservationExpansionResponse(object):
  """
  Attributes:
   - status
   - expansion_id
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'status', (TStatus, TStatus.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'expansion_id', (TUniqueId, TUniqueId.thrift_spec), None, ), # 2
  )

  def __init__(self, status=None, expansion_id=None,):
    self.status = status
    self.expansion_id = expansion_id
  ...
  def write(self, oprot):
    ...
    if self.status is not None:
      ...
      oprot.writeFieldEnd()
    if self.expansion_id is not None:
      oprot.writeFieldBegin('expansion_id', TType.STRUCT, 2)
      self.expansion_id.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class TLlamaAMReleaseRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMReleaseResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaAMGetNodesRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMGetNodesResponse(object):
  """
  Attributes:
   - status
   - nodes
...
class TLlamaAMAdminReleaseRequest(object):
  """
  Attributes:
   - version
   - do_not_cache
...
class TLlamaAMAdminReleaseResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaAMAdminEmptyCacheRequest(object):
  """
  Attributes:
   - version
   - allQueues
...
class TLlamaAMAdminEmptyCacheResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaNMRegisterRequest(object):
  """
  Attributes:
   - version
   - client_id
...
class TLlamaNMRegisterResponse(object):
  """
  Attributes:
   - status
   - nm_handle
...
class TLlamaNMUnregisterRequest(object):
  """
  Attributes:
   - version
   - nm_handle
...
class TLlamaNMUnregisterResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaAMNotificationRequest(object):
  """
  Attributes:
   - version
   - am_handle
...
class TLlamaAMNotificationResponse(object):
  """
  Attributes:
   - status
  """
...
class TLlamaNMNotificationRequest(object):
  """
  Attributes:
   - version
   - nm_handle
...
class TLlamaNMNotificationResponse(object):
  """
  Attributes:
   - status
  """
